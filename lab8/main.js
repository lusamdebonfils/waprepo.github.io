...
let teacher1 = new Person("Luswata");
...
//Question One Test case
console.log("Expected output of teach() is  'Luswata is now teaching English'  " + myFunctionTest('Luswata is now teaching English', function () {
...
//Question One Test case
console.log("Expected output of teach() is  'Luswata is now teaching Mathematics'  " + myFunctionTest('Samuel Luswata is now teaching Mathematics', function () {
...
//TEST CASES
let Student1 = new Student("Luswata Samuel", 12, "Computer Science");
//Student greeting test case
console.log("Expected output of Student1.greeting() is  'Hey, my name is Luswata Samuel and I am studying  Computer Science'  " + myFunctionTest('Hey, my name is Luswata Samuel and I am studying  Computer Science', function () {
...
//TEST CASES
//Student greeting test case
console.log("Expected output of Student.greeting('Computer Science'); is  'Hey, my name is Luswata Samuel and I am studying  Computer Science'  " + myFunctionTest('Hey, my name is Samuel Luswata and I am studying  Computer Science', function () {
